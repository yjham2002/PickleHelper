...
public abstract class BaseActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void showToast(String message){
        ...
        mLongToast.cancel();
        mLongToast = Toast.makeText(getApplicationContext(), message, Toast.LENGTH_LONG);
        mLongToast.show();
    }
    ...
    public void showToastShort(String message){
        ...
        mShortToast.cancel();
        mShortToast = Toast.makeText(getApplicationContext(), message, Toast.LENGTH_SHORT);
        mShortToast.show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //MC add code
        mLongToast = Toast.makeText(getApplicationContext(), "blank", Toast.LENGTH_LONG);
        mShortToast = Toast.makeText(getApplicationContext(), "blank", Toast.LENGTH_SHORT);
    }
